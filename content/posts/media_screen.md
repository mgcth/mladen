...
<div>
	<img width="100%" src="{{posturl}}/20220130_111004.jpg" type="image/jpg">
	<small>Front view.</small>
</div>

<div>
	<video playsinline autoplay loop mute id="video1" height="100%" width="100%">
	    <source src="{{posturl}}/media_screen.mp4" type="video/mp4">
...
<div>
    <div style="display: flex; justify-content: space-between;">
        <img style="width: 49% !important;" src="{{posturl}}/20220130_111022.jpg" type="image/jpg">
        <img style="width: 49% !important;" src="{{posturl}}/20220130_111037.jpg" type="image/jpg">
    </div>
	<small>Top view (left) and side view (right).</small>
</div>

<div>
	<img width="100%" src="{{posturl}}/20220130_110951.jpg" type="image/jpg">
